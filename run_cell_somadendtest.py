...
plt.plot(midget_t_p83, midget_v_p83, label='soma+dend 0.833x')
plt.plot(midget_t, midget_v, label='soma+dend 1x')
#plt.plot(midget_t_1p1, midget_v_1p1, label='soma+dend 1.1x')
plt.plot(midget_t_1p1, midget_v_1p2, label='soma+dend 1.2x')
...
plt.subplot(3,1,3)
plt.plot(parasol_t_p83, parasol_v_p83, label='soma+dend 0.833x')
plt.plot(parasol_t, parasol_v, label='soma+dend 1x')
#plt.plot(parasol_t_1p1, parasol_v_1p1, label='soma+dend 1.1x')
plt.plot(parasol_t_1p1, parasol_v_1p2, label='soma+dend 1.2x')
