...
plt.plot(midget_t_p83, midget_v_p83, label='midget soma 0.833x')
plt.plot(midget_t, midget_v, label='midget soma 1x')
#plt.plot(midget_t_1p1, midget_v_1p1, label='soma 1.1x')
plt.plot(midget_t_1p2, midget_v_1p2, label='midget soma 1.2x')
...
plt.subplot(3,1,3)
plt.plot(parasol_t_p83, parasol_v_p83, label='parasol soma 0.833x')
plt.plot(parasol_t, parasol_v, label='parasol soma 1x')
#plt.plot(parasol_t_1p1, parasol_v_1p1, label='soma 1.1x')
plt.plot(parasol_t_1p2, parasol_v_1p2, label='parasol soma 1.2x')
